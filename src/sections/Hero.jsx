...
const Hero = () => {
  ...
  return (
    <section id="hero" className="w-full lg:px-20 px-10 lg:py-20 py-10 h-[600px] bg-cover bg-center flex flex-col justify-center items-start gap-8" style={{backgroundImage:`linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),url(${banner4})`}} >
      <h1 data-aos="zoom-in" className="text-6xl text-white font-bold lg:w-[45%] md:w-[42%]">Vida é uma combinação de Pizza & Magia</h1>
      <p data-aos="zoom-in" className="text-slate-50 text-xl lg:w-[45%] md:w-[45%]">Em nossa pizzaria, celebramos heróis cotidianos com saborosas pizzas que alimentam corações e inspiram histórias memoráveis</p>
